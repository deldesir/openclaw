...
# OpenClaw Installer for macOS and Linux (Custom Fork: deldesir)
# Usage: curl -fsSL https://raw.githubusercontent.com/deldesir/openclaw/main/scripts/install-custom.sh | bash
...
install_openclaw_from_git() {
    local repo_dir="$1"
    local repo_url="https://github.com/deldesir/openclaw.git"
